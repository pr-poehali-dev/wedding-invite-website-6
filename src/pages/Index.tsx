      ...
      <section id="about" className="py-24 px-6 max-w-3xl mx-auto text-center relative">
        ...
        <Section>
          ...
          <p className="font-golos font-light text-[#4a5a4a] leading-relaxed text-lg">
            Дорогой гость, мы были бы безмерно счастливы видеть вас рядом в самый важный день нашей жизни.
            Этот день будет наполнен любовью, теплом и радостью — именно то, чего нам так хочется разделить с вами.
          </p>
        </Section>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <Section>
              <div className="rounded-2xl overflow-hidden shadow-lg h-80 md:h-[340px]">
                <iframe
                  src="https://www.openstreetmap.org/export/embed.html?bbox=37.59%2C55.74%2C37.65%2C55.77&layer=mapnik&marker=55.755%2C37.620"
              ...
              <a
                href="https://maps.google.com/?q=55.755,37.620"
                target="_blank"
